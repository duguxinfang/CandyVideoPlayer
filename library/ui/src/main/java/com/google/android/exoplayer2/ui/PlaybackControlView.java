...
public class PlaybackControlView extends FrameLayout {
    ...
    private ExoPlayerCtrlScreenListener ctrlScreenListener;
    ...
    public PlaybackControlView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ctrlScreenButton = findViewById(R.id.exo_ctrl_screen);
        if (ctrlScreenButton != null) {
            ctrlScreenButton.setOnClickListener(componentListener);
        }
    }
    ...
    public void setCtrlScreenListener(ExoPlayerCtrlScreenListener listener) {
        this.ctrlScreenListener = listener;
    }
        ...
        public void onClick(View view) {
            if (player != null) {
                if (nextButton == view) {
                    ...
                    controlDispatcher.dispatchSetPlayWhenReady(player, false);
                } else if (ctrlScreenButton == view) {
                    if(ctrlScreenListener == null)
                        return;
                    isExpand = !isExpand;
                    if (isExpand){
                        ((ImageButton)ctrlScreenButton).setImageResource(R.drawable.exo_control_shrink);
                        ctrlScreenListener.onExpandScreen();
                    } else {
                        ((ImageButton)ctrlScreenButton).setImageResource(R.drawable.exo_control_expend);
                        ctrlScreenListener.onShrinkScreen();
                    }
                }
            }
            hideAfterTimeout();
